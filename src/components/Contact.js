        ...
        <div className=' flex flex-col xl:flex-row gap-y-16'>
          ...
          <motion.div variants={fadeIn('left')} initial='hidden' whileInView='show' viewport={{ once: false, amount: 0.4 }} className=' flex-1 xl:pl-[40px] flex justify-center items-center'>
            <form className='flex flex-col gap-y-10 w-full'>
              <input className=' border-b border-dark placeholder:text-[#555] italic tacking-[0.06em] outline-none pb-4' placeholder={form.name} type="text" />
              <input className=' border-b border-dark placeholder:text-[#555] italic tacking-[0.06em] outline-none pb-4' placeholder={form.email} type="text" />
              <input className=' border-b border-dark placeholder:text-[#555] italic tacking-[0.06em] outline-none pb-4' placeholder={form.message} type="text" />
              {/* button */}
