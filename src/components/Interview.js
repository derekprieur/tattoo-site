...
const Interview = () => {
  ...
  return (
    <motion.section variants={fadeIn('up')} initial='hidden' whileInView='show' viewport={{ once: false, amount: 0.1 }} className=' bg-dark section bg-interview bg-no-repeat bg-cover bg-center lg:h-[812px]'>
